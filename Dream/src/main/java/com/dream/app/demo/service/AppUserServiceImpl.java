...
public class AppUserServiceImpl implements AppUserService {
  ...
  /*  @Autowired
    ...
    public AppUser updateUser(AppUser appUser) throws Exception {
        ...
        appUser.setPassword(PasswordUtil.encrypt(appUser.getPassword()));
    ...
    public AppUser getUserByUserId(Long userId) {
        ...
        return appUserRepository.findByUserId(userId)
                .orElseThrow(() -> new AppUserNotFoundException("user not found with user id: " + userId));
    }

    @Override
    public AppUser getUserByUsername(String userName) {
        return appUserRepository.findByUsername(userName)
                .orElseThrow(() -> new AppUserNotFoundException("user not found with username: " + userName));
    }
